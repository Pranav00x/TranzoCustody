...
class CardRepositoryImpl @Inject constructor() : CardRepository {
    ...
    private val _transactions = MutableStateFlow(
        listOf(
            CardTransaction("ct_1", "Amazon", "A", 89.99, "USD", System.currentTimeMillis() - 3600000, TransactionStatus.CONFIRMED),
            CardTransaction("ct_2", "Starbucks", "S", 6.45, "USD", System.currentTimeMillis() - 7200000, TransactionStatus.CONFIRMED),
            CardTransaction("ct_3", "Shell Gas", "S", 52.30, "USD", System.currentTimeMillis() - 86400000, TransactionStatus.CONFIRMED),
            CardTransaction("ct_4", "Spotify", "S", 9.99, "USD", System.currentTimeMillis() - 172800000, TransactionStatus.CONFIRMED),
            CardTransaction("ct_5", "Uber Eats", "U", 24.50, "USD", System.currentTimeMillis() - 259200000, TransactionStatus.CONFIRMED),
            CardTransaction("ct_6", "Netflix", "N", 15.99, "USD", System.currentTimeMillis() - 345600000, TransactionStatus.CONFIRMED),
            CardTransaction("ct_7", "Apple Store", "A", 149.00, "USD", System.currentTimeMillis() - 432000000, TransactionStatus.CONFIRMED)
        )
    )
